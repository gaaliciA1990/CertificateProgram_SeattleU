...
public class Chutes {
   ...
   */
   ...
   /**
   * This method will create a file to store the list of to 10 winners. 
   *
   * @param winnerName  The name of the winner of the game
   */
   public static void writeWinnerFile(String winnerName){
      final String GAMEWINNERS = "WinnerList.txt"; 
      
      // Open the file to append the name to the file
      FileWriter fileWrite = new FileWriter(GAMEWINNERS, true);
   ...
   * @param winnerName  The name of the winner of the game
   */
   public static String[] getWinnerList(String winnerFile){
